...
public class SpotifyApi {
    ...
    public TokenResponse refresh() {
        ...
        TokenResponse tokenResponse = restTemplate.postForObject("https://accounts.spotify.comp/api/token", request,
                TokenResponse.class);
    ...
    public Map<?, ?> recommendations(List<String> chosenGenres) {
        ...
        return get("https://api.spotify.comp/v1/recommendations?seed_genres=" + genres,
                Map.class);
    }
    ...
    public String createPlaylist(String spotifyId, String playlistName, String description) {
        ...
        return post("https://api.spotify.comp/v1/users/" + spotifyId + "/playlists", requestBody, Map.class)
                .get("id").toString();
    }
    ...
    public void addTracksToPlaylist(String playlistId, List<String> trackUris) {
        ...
        post("https://api.spotify.comp/v1/playlists/" + playlistId + "/tracks", requestBody, Map.class);
    }
}
